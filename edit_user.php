    ...
    <div class="alert alert-info" role="alert">
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="menu.php"> INPUT PRODUCT</a>
            </li>
            <li class="nav-item active">
              <a class="nav-link" href="user.php">INPUT PELANGGAN</a>
            </li>
          </ul>
      ...
      <form method="POST" action="proses.php">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <select class="form-control" placeholder="Pilih" id="kriteria" name="jenis_kelamin" required>
        ...
        <div class="form-group row">
          <div class="col-sm-10">
            <button type="submit" class="btn btn-primary" value="update-peminjam" name="aksi">Edit</button>
